package com.nemo.wxpay_library.view;
...
import com.nemo.wxpay_library.R;
...
public class ShareDialog extends BaseDialog {
    //界面显示的数据
    private String[] mTexts = {"微信好友", "微信朋友圈", "微信收藏"};
    private int[] mImgs = {R.drawable.icon_socialize_wechat,
            R.drawable.icon_socialize_wxcircle, R.drawable.icon_socialize_fav};//图片数据
